...
static struct opt_type key_options[] = {
	...
	{ODI,ARG_SET_CREDITS,ARG_SET_CREDITS_MAX,0,9,2,A_CS1,A_ADM,A_DYI,A_CFA,A_ANY,0,     MIN_SET_CREDITS_MAX,MAX_SET_CREDITS_MAX,0,0,        opt_set_credits,
			ARG_VALUE_FORM,	HLP_SET_CREDITS_MAX},
	{ODI,ARG_SET_CREDITS,ARG_SET_CREDITS_PREF,0,9,2,A_CS1,A_ADM,A_DYI,A_CFA,A_ANY,0,    MIN_SET_CREDITS_PREF,MAX_SET_CREDITS_PREF,0,0,      opt_set_credits,
